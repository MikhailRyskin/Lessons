...
print(super_zip(data_1, data_2))

zip_list_1 = list(super_zip(data_1, data_2))
print(zip_list_1)
zip_list_2 = list(super_zip(data_3, data_4))
print(zip_list_2)
zip_list_3 = list(super_zip(data_5, data_2))
print(zip_list_3)


# "сделайте так, чтобы программа работала с любыми итерируемыми типами данных"
